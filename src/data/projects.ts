...
export const projects: Project[] = [
  ...
  },
  {
    id: 'jemultiplie',
    title: 'JeMultiplie',
    description: 'Projet personnel de développement d\'un site d\'entraînement au calcul mental avec un système de renforcement adaptatif qui permet de revoir les erreurs.',
